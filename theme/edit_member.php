...
<div id="wrapper">
		...
		?>
			...
			<p><a class="btn btn-info" href="memberList.php"><i class="icon-arrow-left icon-large"></i>&nbsp;Back</a></p>
	...
	<form class="form-horizontal" method="POST" action="update_member.php">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type='tel' class="search" name="contact"  placeholder="Phone Number"  autocomplete="off"  maxlength="11" >
			</div>
		</div>
		<div class="control-group">
